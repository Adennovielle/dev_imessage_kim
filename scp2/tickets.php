...
$ost->addExtraHeader('<script type="text/javascript" src="js/ticket.js?39ab0c5"></script>');
$ost->addExtraHeader('<script type="text/javascript" src="js/thread.js?39ab0c5"></script>');

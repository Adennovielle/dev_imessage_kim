...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="outer_box_green">
                        ...
                        <div class="box-body">
                            ...
                            <p><?php echo __('Please provide as much detail as possible so we can assist you more effectively. To update a previously submitted ticket, please log in.') ?></p>
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="outer_box_blue">
                        ...
                        <div class="box-body">
                            ...
                            <p><?php echo __('We maintain a complete archive and history of your current and past support requests, including all responses.') ?></p>

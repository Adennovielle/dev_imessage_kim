...
if (osTicket::is_ie())
    $ost->setWarning(__('iMessage no longer supports Internet Explorer.'));
?>>
<head>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="iMessage, Customer support system, support ticket system">
      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <a href="<?php echo ROOT_PATH; ?>index.php" class="logo">
            <img src="<?php echo ASSETS_PATH; ?>images/logo.png" alt="Securities and Exchange Commission">
          </a>
          <!-- ***** Logo End ***** -->
          ...
          <ul class="nav">
            <?php
              ...
              if ($thisclient && is_object($thisclient) && $thisclient->isValid() && !$thisclient->isGuest()) {
                  echo '<li><div class="gradient-button"><a href="' . $signout_url . '"><i class="fa fa-sign-out-alt"></i> Sign Out</a></div></li>';

...
if(!isset($_GET['code'])) 
{
  ...
  if(!isset($_SESSION['sub'])) 
    {     
    // header('Location:'.'https://imessage.sec.gov.ph/index.php?');
    //}else{
  ...
  if($userinfo->sub) 
  {
    ...
    //testing insert;
    date_default_timezone_set('Asia/Manila');
    $conn = new mysqli('127.0.0.1', 'qdm1n1stqrt0r', 'ewFNVEu7r@f[nqAuSoyMo{n', 'imessage');

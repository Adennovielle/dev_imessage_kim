<?php
include_once(INCLUDE_DIR.'staff/keycloak.php');
...
<div id="loginBox">
    ...
    <h1 id="logo"><a href="index.php">
        ...
        <img src="logo.php?login" alt="i-Message Mo :: <?php echo __('Staff Control Panel');?>" />
    </a></h1>
    <h3 style="color:green"><b>Verifying account, please wait . . . .</b></h3>
    ...
    <form action="login.php" method="post" id="login" name="login" onsubmit="attemptLoginAjax(event)">
        <?php csrf_token();
        if ($thisstaff
        ...
        <?php
            ...
            <fieldset>
            <input type="hidden" name="userid" id="name" value="<?php echo $_SESSION['username']; ?>" placeholder="<?php echo __('Email or Username'); ?>"
...
<!-- <div id="poweredBy"><?php echo __('Powered by'); ?>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
            document.createElement('form').submit.call(document.getElementById('login'));
            });

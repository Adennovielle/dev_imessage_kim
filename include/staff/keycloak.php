<?php
session_start();
$client_id = 'imessage_staff';
$client_secret = 'CQxZDDtEkkW5Iv0u8F28hH4TYh61VskY';
$redirect_uri = 'https://intranet.sec.gov.ph/osticket/scp/';
$metadata_url = 'https://privateiam.sec.gov.ph/realms/SEC-Private/.well-known/openid-configuration';
